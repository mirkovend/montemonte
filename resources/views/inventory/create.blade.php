                    ...
                    <div class="row spacing">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('adjustment_item',([''=>'Select Item'] + $item->all()),null,['class'=>'form-control']) !!}
                            </div>
                        </div>
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <table class="table" id="tableitem">
                                ...
                                <tbody>
                                    <tr id="i0">
                                        <td>
                                        {!! Form::select('items_id[]',([''=>'Select Item'] + $item->all()),null,['id'=>'items','class'=>'form-control items']) !!}
                                        <input type="hidden" class="itemprice" name="itemprice[]" value="0">
                                        </td>
                                        <td class="qtyonhand text-center">0.00</td>
                                        <td><input type="text" name="quantity[]" class="form-control" value="0"></td>
                                        <td><button class="btn btn-primary" id="addmore"><span class=" glyphicon glyphicon-plus"></span></button></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('lm_quantity',0,['class'=>'form-control']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
