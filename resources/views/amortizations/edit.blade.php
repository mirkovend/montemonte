  ...
  <div class="col-lg-12">
    <h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Table of Amortization</li>
        </ol>
    </h2>
  </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="ibox float-e-margins">
                ...
                {!! Form::model($batch,['method'=>'patch','action'=>['AmortizationController@update',$id]]) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            var heads1 = parseFloat($('#heads').val()) || 0;
            var cost1 = parseFloat($('#cost').val()) || 0;
