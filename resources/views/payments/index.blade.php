			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="pull-right">
		            	...
		            	<a class="btn btn-md btn-primary" href="{{ action('PaymentController@create')}}"><span class="fa fa-plus"></span> Create Entry</a>
		            	</div>
		            </div>
				    				...
				    				<td width = 80 class="text-center">
				    					<div class="btn-group">
				                            ...
				                            <ul class="dropdown-menu dropdown-menu-arrow" role="menu" style="text-align:left;text-transform:uppercase;">
				                                <li><a href="{{ action('PaymentController@edit',$data->id) }}"><span class="icon-edit"></span> Edit Entry</a></li>
