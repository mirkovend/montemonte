  ...
  <div class="col-lg-12">
    <h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Cash Invoice</li>
        </ol>
    </h2>
  </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                  	...
                  	{!! Form::open(['method'=>'PATCH','action'=>['CashinvoiceController@update',$id]]) !!}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Payee</label>
                                 
	                                    {!! Form::select('cash_invoice_to',collect(['' => 'PLEASE SELECT'] + $customer->all()),$invoice->cash_invoice_to,['class'=>'form-control js-example-basic-single']) !!}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('cash_invoice_number',$invoice->cash_invoice_number,['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="checkbox" style="margin-top:30px;">
                                    <label>
                                    @if($invoice->status==1)
                                    	 <input value="1" type="checkbox" name="status" checked>
                                    @else
                                ...
                                @foreach($invoice->invoice as $item)
	                                <div class="wrapp">
	                                    <div class="col-md-3">
	                                        <div class="form-group">
	                                            {!! Form::label('','Quantity:') !!}
	                                            <input type="text" name="cash_invoice_qty[]" class="form-control qty" id="qty" value="{{$item->cash_invoice_qty}}"/>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-3">
	                                        <div class="form-group">
