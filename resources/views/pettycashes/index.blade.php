			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="pull-right">
		            	...
		            	<a class="btn btn-md btn-primary" href="{{ action('PettycashController@create')}}"><span class="fa fa-plus"></span> Create Entry</a>
		            	</div>
		            </div>
						...
						<table class="table table-bordered table-striped" id="tableSortable" style="text-transform:uppercase;">
				    		...
				    		<tbody>
				    			...
				    			<tr>
				    				...
				    				<td>PCF - {{ $data->pcf_number }}</td>
				    				<td>{{ $data->supplier->first()->supplier_name }}</td>
				    				<td>P {{ number_format($data->invoice->where('pcf_number',$data->pcf_number)->sum('amount'),2) }}</td>
				                    <td>{{ $data->dept }}</td>
				    				...
				    				<td width = 80 class="text-center">
				    					<div class="btn-group">
				                            ...
				                            <ul class="dropdown-menu dropdown-menu-arrow" role="menu" style="text-align:left;text-transform:uppercase;">
				                                <li><a href="{{ action('PettycashController@edit',$data->id) }}"><span class="icon-edit"></span> Edit Entry</a></li>
				                                @if($data->status == 0)
