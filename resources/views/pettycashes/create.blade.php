    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="ibox float-e-margins">
                ...
                {!! Form::open(['method'=>'POST','action'=>'PettycashController@store']) !!}
                    ...
                    <div class="row spacing">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('pcf_number',$start_number,['class'=>'form-control']) !!}
                            </div>
                        </div>
                    ...
                    <div id="wrap">
                        <div class="wrapp">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    {!! Form::label('','Cost:') !!}
                                    <input type="text" name="unit_cost[]" class="form-control unit_cost" id="unit_cost"/>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var data = '<div class="clearfix"></div><div class="wrapp'+x+'" style="margin-top:20px;"><div class="clearfix"></div>'; 
            ...
            data += '<div class="col-md-2"><div class="form-group">{!! Form::select("dept[]",[""=>"PLEASE SELECT","ADMIN"=>"ADMIN","GADMIN"=>"GENERAL ADMIN","HATCHERY"=>"HATCHERY","LAYER"=>"LAYER"],null,["class"=>"form-control select"]) !!}';
            data += '</div></div>';
            

            data += '<div class="col-md-3"><div class="form-group">{!! Form::select("account_item_id[]",collect(["" => "PLEASE SELECT"] + $coa_item->all()),null,["class"=>"form-control select"]) !!}';
            data += '</div></div>';
