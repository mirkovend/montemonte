                ...
                <div class="ibox-content">
                    ...
                    {!! Form::open(['method'=>'POST','action'=>'ChargeinvoiceController@store']) !!}
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    {!! Form::label('','Charge Invoice Number:') !!}
                                    {!! Form::text('charge_invoice_number',$start_number,['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div id="wrap">
                                <div class="wrapp">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            {!! Form::label('','Quantity:') !!}
                                            <input type="text" name="charge_invoice_qty[]" class="form-control qty" id="qty" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
