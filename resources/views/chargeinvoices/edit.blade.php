  ...
  <div class="col-lg-12">
    <h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#" style="color:#2196f3">Charge Invoice</a></li>
            <li class="breadcrumb-item active">Edit Charge Invoice</li>
        </ol>
    </h2>
  </div>
</div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                    {!! Form::open(['method'=>'PATCH','action'=>['ChargeinvoiceController@update',$id]]) !!}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Payee</label>
                                   @if($newcustomer == NULL)
                                            {!! Form::select('customer_id',collect(['' => 'PLEASE SELECT'] + $customer->all()),null,['class'=>'form-control js-example-basic-single']) !!}
                                    @else
                                        {!! Form::select('customer_id',collect(['' => 'PLEASE SELECT'] + $customer->all()),$newcustomer->id,['class'=>'form-control js-example-basic-single']) !!}
                                    @endif
                                </div>
                            </div>
                            ...
                            <hr>
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('dt',$invoice->dt,['class'=>'form-control dt','datepicker'=>'','data-date-format'=>'yyyy-mm-dd','data-auto-close'=>'true']) !!}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('charge_invoice_number',$invoice->charge_invoice_number,['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('dept',[''=>'PLEASE SELECT','ADMIN'=>'ADMIN','GADMIN'=>'GENERAL ADMIN','HATCHERY'=>'HATCHERY','LAYER'=>'LAYER'],$invoice->dept,['class'=>'form-control select']) !!}
                                </div>
                            </div>
                            	...
                            	@foreach($invoice->invoice as $item)
	                                <div class="wrapp">
	                                    <div class="col-md-3">
	                                        <div class="form-group">
	                                            {!! Form::label('','Quantity:') !!}
	                                            <input type="text" name="charge_invoice_qty[]" class="form-control qty" id="qty" value="{{$item->charge_invoice_qty}}"/>
	                                        </div>
	                                    </div>
	                                    <div class="col-md-3">
	                                        <div class="form-group">
	                                            {!! Form::label('','Size:') !!}
	                                            {!! Form::select('size_id[]',collect(['' => 'PLEASE SELECT'] + $size->all()),$item->size_id,['class'=>'form-control js-example-basic-single']) !!}
	                                        </div>
	                                    </div>
	                                    <div class="col-md-2">
	                                        <div class="form-group">
	                                            {!! Form::label('','Unit Price:') !!}
	                                            <input type="text" name="unit_price[]" class="form-control unit_price" id="unit_price" value="{{$item->unit_price}}" />
	                                        </div>
	                                    </div>
	                                    <div class="col-md-2">
	                                        <div class="form-group">
	                                            {!! Form::label('','Amount:') !!}
	                                            <input type="text" name="amount[]" class="form-control amount" id="amount" value="{{$item->amount}}" />
	                                        </div>
	                                    </div>
	                                    <div class="col-md-2">
	                                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var data = '<div class="clearfix"></div><div class="wrapp'+x+'" style="margin-top:20px;"><div class="clearfix"></div><div class="col-md-3"><div class="form-group">';
            data += '<input type="text" name="charge_invoice_qty[]" class="form-control qty" id="qty" />';
            data += '</div></div>';
