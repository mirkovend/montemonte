	...
	<div class="col-lg-12">
		<h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Vouchers Payment</li>
			</ol>
		</h2>
	</div>
</div>
			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					...
					<div class="pull-right">
		            	...
		            	<a class="btn btn-md btn-primary" href="{{ action('VouchersPaymentController@create')}}"><span class="fa fa-plus"></span> Create Entry</a>
		            	</div>
		            </div>
				    				...
				    				<td width = 80 class="text-center">
				    					<div class="btn-group">
				                            ...
				                            <ul class="dropdown-menu dropdown-menu-arrow" role="menu" style="text-align:left;text-transform:uppercase;">
				                                <li><a href="#"><span class="icon-edit"></span> Edit Entry</a></li>
				                                <li><a href="#"><span class="icon-remove"></span> Delete Entry</a></li>
				                            </ul>
				                        </div>
				    				</td>
				    			</tr>
