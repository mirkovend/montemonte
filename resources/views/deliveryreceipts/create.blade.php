  ...
  <div class="col-lg-12">
    <h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add Delivery Receipt</li>
        </ol>
    </h2>
  </div>
</div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    @endif
                        {!! Form::open(['method'=>'POST','action'=>'DeliveryreceiptController@store']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    ...
                    {!! Form::text('delivery_receipt_number',$start_number,['class'=>'form-control']) !!}
                </div>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                    {!! Form::label('','Delivered to:') !!}
                    {!! Form::text('delivery_receipt_to',null,['class'=>'form-control']) !!}
                </div>
            </div>
        </div>
        <hr>
        ...
        <div id="wrap">
            <div class="wrapp">
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('','Quantity:') !!}
                        <input type="text" name="delivery_receipt_qty[]" class="form-control qty" id="qty" />
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('','Size:') !!}
                        {!! Form::select('size_id[]',collect(['' => 'PLEASE SELECT'] + $size->all()),null,['class'=>'form-control size js-example-basic-single']) !!}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
        ...
        <div id="wrappe">
            <div class="wrappers">
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('','Quantity:') !!}
                        <input type="text" name="house_qty[]" class="form-control qty2" id="qty2" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('','House:') !!}
                        {!! Form::select('house_id[]',collect(['' => 'PLEASE SELECT'] + $house->all()),null,['class'=>'form-control unit js-example-basic-single']) !!}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var data = '<div class="clearfix"></div><div class="wrappers'+x+'" style="margin-top:20px;"><div class="clearfix"></div><div class="col-md-3"><div class="form-group">';  
            ...
            data += '<button type="button" class="btn btn-primary minus2" ><i class="fa fa-minus" aria-hidden="true"></i></button>';
            data += '</div></div></div>';
        ...
        var data = '<div class="clearfix"></div><div class="wrapp'+y+'" style="margin-top:20px;"><div class="clearfix"></div><div class="col-md-3"><div class="form-group">';  
            ...
            // data += '<div class="col-md-3"><div class="form-group">';  
            // data += '{!! Form::select("unit_id[]",collect(["" => "PLEASE SELECT"] + $unit->all()),null,["class"=>"form-control js-example-basic-single"]) !!}';
            // data += '</div></div>';
